...
class UserLoginTestCase(APITestCase):
    ...
    def test_authentication_with_valid_data(self):
        ...
        response = self.client.post(
            ...
            data={"username": "kimjihong", "password": "password"},
        )
    ...
    def test_authentication_missing_required_fields(self):
        ...
        for pop_field in required_fields:
            data.pop(pop_field)
            response = self.client.post(path=f"{BASE_API_URL}/login", data=data)
    ...
    def test_authentication_with_wrong_password(self):
        ...
        response = self.client.post(
            path=f"{BASE_API_URL}/login",
            data={"username": "kimjihong", "password": "wrong-password"},
        )
...
class TokenBlacklistTestCase(APITestCase, JWTSetupMixin):
    ...
    def test_user_logout_and_blacklisted_token(self):
        ...
        response = self.client.post(path=f"{BASE_API_URL}/logout")
    ...
    def test_token_refresh_rotate(self):
        ...
        response = self.client.post(path=f"{BASE_API_URL}/refresh")
